 ...
 *
 * 1) Declare a 'png_image' structure on the stack and () it to all zero.
 ...
 * the png_controlp field 'opaque' to NULL (or, safer,  the whole thing.)
 */
#ifdef PNG_STDIO_SUPPORTED
 ...
 * be written.  To do this use  to set the whole structure to 0 then
